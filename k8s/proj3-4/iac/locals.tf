locals {
  ...
  common_labels = merge(local.labels, local.selector_labels, {
    "app.kubernetes.io/instance"   = var.application_settings.name
    "app.kubernetes.io/managed-by" = "terraform"
    "app.kubernetes.io/name"       = var.application_settings.name
  })

  labels = {
    "app.kubernetes.io/component" = var.application_settings.name
    "app.kubernetes.io/part-of"   = var.application_settings.image
    "app.kubernetes.io/version"   = var.application_settings.version
  }
