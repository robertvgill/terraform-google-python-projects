...
output "psql_backup_enabled" {
  description = "Daily backup of the persistent volume claim for PostgreSQL"
  value       = var.postgresql_settings.create ? var.postgresql_backup.enabled : null
}
